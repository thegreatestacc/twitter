...
--changeset Morra:create-identity-schema
--comment create new identity schema
create schema identity;
--rollback drop schema identity;

--changeset Morra:create-identity-user_accounts-table
...
--changeset Morra:create-identity-user_roles-table
...
--changeset Morra:create-identity-user_accounts_roles-table
...
--changeset Morra:add-user_accounts_roles-table-constraints
...
--rollback alter table identity.user_account_roles drop constraint user_accounts_roles__user_role__fk;
--rollback alter table identity.user_account_roles drop constraint user_account_roles__user_accounts_fk;
--rollback alter table identity.user_accounts_roles drop constraint user_accounts_roles_unique;

--changeset Morra:add-data-to-user_roles-table
